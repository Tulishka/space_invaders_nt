...
level = [
    ...
    LevelSettings(8, (3, 2, 2, 1, 1), (40, 320), 2.5, 0.3, (0, 1, 2, 0, 1, 2, 0, 1), 0, 0, 60, False),
    LevelSettings(8, (3, 3, 3, 2, 2, 1), (50, 340), 2.0, 0.3, (1, 0, 1, 2, 1, 2, 0, 1), 0, 0, 70, False),
    LevelSettings(8, (7, 3, 3, 2, 1), (50, 350), 2.0, 0.3, (1, 0, 2, 1, 1, 1, 0, 2), 0, 0, 80, False),
    LevelSettings(8, (7, 3, 3, 2, 2), (60, 360), 1.8, 0.3, (1, 1, 2, 1, 1, 1, 2, 1), 0, 0, 70, True),
